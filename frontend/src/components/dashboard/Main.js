        ...
        <div className='col-2 d-flex flex-column align-items-center border justify-content-center pt-4' style={{height:"100vh"}}>
          ...
          <div className='mt-3'>
            <ul type="none">
              ...
              <li className='mb-3'>
                <Link className='nav-link fs-3' to="/dashboard/contact">Contact</Link>
              </li>
              <li className='mb-3'>
        ...
        <div className="col-10 px-4 pt-4">
          <div className='w-100 d-flex justify-content-between mt-2'>
            ...
            <div className='d-flex align-items-center justify-content-center'>
              <h2>Notification</h2>
              <div className='bg-primary rounded-circle fs-5 d-flex justify-content-center align-items-center text-white ms-2' style={{height:"50px", width:"50px"}}>3</div>
            </div>
          </div>
